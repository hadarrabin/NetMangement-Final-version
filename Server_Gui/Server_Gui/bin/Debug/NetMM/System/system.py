...
PROCESS_USAGE_LIMIT = 101 - (100 / multiprocessing.cpu_count())
SIZE = Config.SIZE
# ===========================================================================================
...
# -- Permissions --
Process_Permission = (0x000F0000L | 0x00100000L | 0xFFF)

# ============================================================================ Memory

proc = KERNEL_32.OpenProcess(Process_Permission, False, 14436)

# ============================================================================ System

def get_registry_value(key, skey, value):
    """
...
class System:
    ...
    def get_processes_dict(self):
        ...
        try:
            ...
            z, proc_name = win32pdh.EnumObjectItems(None, None, self.process_obj,
    ...
    def create_process_handle_dict(self, procsses):
        ...
        """
        for pid in procsses:
            proc_handle = ctypes.windll.Kernel32.OpenProcess(Process_Permission, False, pid)
...
class Process_Memory(Structure):
    _fields_ = [
        ('cb', DWORD),
